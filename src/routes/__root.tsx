...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MAISON LUMIÈRE — Beleza de Alto Padrão" },
      {
        name: "description",
        content:
          "Cosméticos, skincare e perfumaria de luxo selecionados para mulheres exigentes.",
      },
      { name: "author", content: "Maison Lumière" },
      { property: "og:title", content: "MAISON LUMIÈRE — Beleza de Alto Padrão" },
      {
