...
const categories = [
  { name: "Maquiagem", img: makeup, count: "148 produtos" },
  { name: "Skincare", img: skincare, count: "96 produtos" },
  { name: "Perfumes", img: perfume, count: "72 produtos" },
  { name: "Cabelos", img: hair, count: "64 produtos" },
  { name: "Corpo e Banho", img: body, count: "58 produtos" },
